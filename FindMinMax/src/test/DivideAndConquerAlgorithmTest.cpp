...
#include "../main/algorithms/DivideAndConquerAlgorithm.h"

using namespace std;

namespace {
	class DivideAndConquerAlgorithmTest : public testing::Test,
	                                      public testing::WithParamInterface<tuple<int, int, vector<int>>> {

		public:
			MinMaxFinderAlgorithm* algo = new DivideAndConquerAlgorithm{};
		protected:
			void SetUp() override {
				Test::SetUp();
			}
...
TEST_P(DivideAndConquerAlgorithmTest, FindMinMax_returns_min_and_max_of_array) {
